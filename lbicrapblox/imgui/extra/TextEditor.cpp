...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::PizzaParty()
{
	static bool inited = false;
	static LanguageDefinition langDef;
	if (!inited)
	{
		...
		static const char* const identifiers[] = {
			...
			"select",  "setmetatable",  "tonumber",  "tostring",  "type",  "xpcall",  "_G",  "_VERSION","arshift", "band", "bnot", "bor", "bxor", "btest", "extract", "lrotate", "lshift", "replace",
			"rrotate", "rshift", "create", "resume", "running", "status", "wrap", "yield", "isyieldable", "debug","getuservalue", "gethook", "getinfo", "getlocal", "getregistry", "getmetatable",
			"getupvalue", "upvaluejoin", "upvalueid", "setuservalue", "sethook", "setlocal", "setmetatable", "setupvalue", "__gc", "__tostring", "abs", "acos", "asin", "atan", "ceil", "cos", "deg", "exp", "tointeger",
			"floor", "fmod", "ult", "log", "max", "min", "modf", "rad", "random", "randomseed", "sin", "sqrt", "string", "tan", "type", "atan2", "cosh", "sinh", "tanh",
			"pow", "frexp", "ldexp", "log10", "pi", "huge", "maxinteger", "mininteger", "byte", "char", "dump", "find", "format", "gmatch", "gsub", "len", "lower", "match", "rep",
			"reverse", "sub", "upper", "unpack", "concat", "maxn", "insert", "pack", "unpack", "remove", "move", "sort", "char", "len",
			"coroutine", "table", "string", "math", "debug",
			/* roblox globals */
			"script", "warn", "Warn", "game", "Game", "workspace", "Workspace", "shared", "settings", "Settings",
			"tick", "time", "elapsedTime", "ElapsedTime", "wait", "Wait",
			"delay", "Delay", "ypcall", "spawn", "Spawn", "printidentity", "UserSettings", 
			"PluginManager", "LoadLibrary", "warn",
			"stats", "Stats", "Version", "version",
			"Enum", "CFrame", "Vector3", "Region3", "Region3int16", "Vector3int16Bridge", "Vector2int16Bridge", "Axes", "UDim2", "UDim", "Faces", "CellID", "Instance",
			"Rect2D", "Ray", "Color3", "BrickColor", "ColorSequence", "NumberSequence", "NumberRange"
		};
		for (auto& k : identifiers)
		{
			Identifier id;
